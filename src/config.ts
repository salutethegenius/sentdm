...
export const DEFAULT_BATCH_SIZE = Number(process.env.SENT_DM_BATCH_SIZE ?? 100);
export const DEFAULT_BATCH_DELAY_MS = Number(process.env.SENT_DM_BATCH_DELAY_MS ?? 5000);
